...
for r in r_csv:
    ...
    img = cv.imread(str(input_filename))
    ...
    cv.rectangle(img, (x0, y0), (x1, y1), (0, 0, 255), thickness = 3)
    cv.circle(img, (x0, y0), 9, (0, 255, 0), thickness = 1)
    cv.circle(img, (x1, y1), 9, (255, 0, 0), thickness = 1)
    cv.line(img, ((x0 + x1) // 2, (y0 + y1) // 2), (px, py), (0, 0, 0), 2, cv.LINE_AA)
    cv.circle(img, (px, py), 15, (255, 0, 255), thickness = 3)
